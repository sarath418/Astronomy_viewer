...
<body>
    ...
    <div class="content"> <!-- Added a content div to add padding -->
        <div class="text">
            <h1>SAGITTARIUS</h1>
            <p>Sagittarius is a prominent constellation in the southern hemisphere and can be observed from Africa. The best time, day, and month to see Sagittarius from Africa or any other location in the southern hemisphere can be summarized as follows:</p>
            <ul>
                <li><h2>Time of Year</h2>Sagittarius is most visible during the winter months in the southern hemisphere. In Africa, this corresponds to the period from May to August.</li>
                <li><h2>Time of Day</h2>Sagittarius is an evening constellation, so it is best seen after sunset. It rises in the southeast and moves across the night sky, setting in the southwest during the early hours of the morning. The best viewing time is a few hours after sunset when it is higher in the sky.</li>
                <li><h2>Best Months</h2>The best months to see Sagittarius from Africa are typically from May to August. During this period, Sagittarius is well-placed in the evening sky, and its prominent Teapot asterism is easy to identify.</li>
            </ul>
        </div>
        <div class="image">
