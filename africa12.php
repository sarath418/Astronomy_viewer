...
<body>
    ...
    <div class="content"> <!-- Added a content div to add padding -->
        <div class="text">
            <h1>Pegasus</h1>
            <p>
The best time, day, and month to see the Pegasus constellation from Africa, or any other location, depend on several factors, including the time of year and your specific location within Africa. Here are some general guidelines:</p>
            <ul>
                <li><h2>Time of Year</h2>Pegasus is a prominent autumn constellation in the Northern Hemisphere, and it is best seen during the fall months. In Africa, this means the best time to see Pegasus is typically from late summer to late autumn.</li>
                <li><h2>Time of Day</h2>Pegasus is visible during the evening hours and is considered an evening constellation. It rises in the eastern part of the sky and moves across the night sky, setting in the west during the early hours of the morning. The best viewing time is a few hours after sunset when it is higher in the sky.</li>
                <li><h2>Best Months</h2>The best months to see Pegasus from Africa would typically be from August to November. During this period, Pegasus is well-placed in the evening sky and can be observed for an extended duration.</li>
            </ul>
        </div>
        <div class="image">
