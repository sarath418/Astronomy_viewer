...
<body>
    ...
    <div class="content"> <!-- Added a content div to add padding -->
        <div class="text">
            <h1>URSA MINOR</h1>
            <p>
The best time, day, and month to see the Ursa Minor constellation from Africa, or any other location in the Northern Hemisphere, depends on the time of year and your specific location within Africa. Here are some general guidelines:</p>
            <ul>
                <li><h2>Time of Year</h2>Ursa Minor is a circumpolar constellation, which means it never sets below the horizon and is visible year-round in the Northern Hemisphere.<br><br>In Africa, Ursa Minor is visible in the night sky during all seasons.</li>
                <li><h2>Time of Day</h2>In Africa, Ursa Minor is visible in the night sky during all seasons.<br><br>The best viewing time is a few hours after sunset when the constellation is well above the horizon.<br><br>It remains visible throughout the night.</li>
                <li><h2>Best Months</h2>Ursa Minor can be observed from Africa throughout the year.<br><br>However, it is more prominently visible during the summer months (from late spring to early autumn) when it appears higher in the northern sky.</li>
            </ul>
        </div>
        <div class="image">
