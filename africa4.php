...
<body>
    ...
    <div class="content"> <!-- Added a content div to add padding -->
        <div class="text">
            <h1>CASSIOPEIA</h1>
            <p>
Cassiopeia is a prominent constellation in the night sky, and its visibility from Africa, as well as any other location, depends on the time of year and your specific location within Africa. Here are some general guidelines for the best time, day, and month to see Cassiopeia from Africa:</p>
            <ul>
                <li><h2>Time of Year</h2>Cassiopeia is a circumpolar constellation for many locations in Africa, which means it can be seen year-round. However, its visibility varies throughout the year due to its position in the sky.<br><br>In northern parts of Africa, Cassiopeia is visible all year long and may be best observed during the winter months, from October to March.</li>
                <li><h2>Time of Day</h2>Cassiopeia is visible in the evening and night sky. You can typically see it after sunset and throughout the night.<br><br>The best time to observe Cassiopeia is during the late evening when it is higher in the sky and away from the horizon's atmospheric interference.</li>
                <li><h2>Best Months</h2>In northern Africa, Cassiopeia is more prominent in the winter months (October to March) when it appears higher in the northern sky.<br><br>In southern parts of Africa, Cassiopeia is visible during the summer months (December to June) when it appears higher in the southern sky.</li>
            </ul>
        </div>
        <div class="image">
