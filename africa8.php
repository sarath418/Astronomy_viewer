...
<body>
    ...
    <div class="content"> <!-- Added a content div to add padding -->
        <div class="text">
            <h1>CYGNUS</h1>
            <p>
Cygnus is a constellation located in the northern celestial hemisphere, so its visibility from Africa is subject to seasonal variations. The best time, day, and month to see Cygnus from Africa would generally be during the summer months in the northern hemisphere, specifically from late spring to early autumn. Here are some guidelines:</p>
            <ul>
                <li><h2>Time of Year</h2>Cygnus is most prominent during the summer months. In Africa, this corresponds to the period from late spring (around May) through early autumn (around September). During this time, Cygnus is well-placed in the night sky.</li>
                <li><h2>Time of Day</h2>Cygnus is an evening constellation, so it is best observed after sunset. It rises in the northeastern sky and moves across the celestial dome, setting in the northwest during the early hours of the morning. The best viewing time is a few hours after sunset when it is higher in the sky.</li>
                <li><h2>Best Months</h2>The best months to see Cygnus from Africa are typically from May to September. These months offer the longest and most favorable viewing opportunities.</li>
            </ul>
        </div>
        <div class="image">
