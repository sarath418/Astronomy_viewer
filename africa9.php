...
<body>
    ...
    <div class="content"> <!-- Added a content div to add padding -->
        <div class="text">
            <h1>TAURUS</h1>
            <p>
Taurus is a prominent constellation and can be observed from Africa at different times, depending on the season and your specific location within the continent. Here are some general guidelines for the best time, day, and month to see Taurus from Africa:</p>
            <ul>
                <li><h2>Time of Year</h2>Taurus is most visible during the winter and early spring months in the Northern Hemisphere, which corresponds to the southern summer and early autumn months in the Southern Hemisphere.<br><br>In Africa, the best time to see Taurus is typically from late autumn to early spring when it is well-placed in the evening sky.</li>
                <li><h2>Time of Day</h2>Taurus is an evening constellation, meaning it is best observed after sunset.<br><br>It rises in the eastern part of the sky and sets in the west during the late evening hours.</li>
                <li><h2>Best Months</h2>The best months to see Taurus from Africa would typically be from October to March.<br><br>During this period, Taurus is prominent in the evening sky, and you can observe its distinctive V-shaped star cluster called the "Hyades" and the bright red giant star Aldebaran, which represents the eye of the bull.</li>
            </ul>
        </div>
        <div class="image">
