...
<body>
    ...
    <div class="content"> <!-- Added a content div to add padding -->
        <div class="text">
            <h1>ORION</h1>
            <p>
The best time, day, and month to see the Orion constellation from Antarctica are quite different from other locations due to Antarctica's unique location and extreme climate conditions. Here are some general guidelines for observing Orion from Antarctica:</p>
            <ul>
                <li><h2>Time of Year</h2>In Antarctica, the best time to see Orion is during the austral winter, which corresponds to the boreal summer in the Northern Hemisphere. The austral winter in Antarctica occurs from late March to early September. During this period, the long polar nights provide extended hours of darkness, making it an ideal time for stargazing.</li>
                <li><h2>Time of Day</h2>Given the extreme southern latitude of Antarctica, Orion is visible in the night sky for a significant portion of the austral winter. Since Antarctica is near the South Pole, Orion can be seen circling the southern celestial pole. As a result, it can be observed throughout the night, making late evening to early morning the most favorable time for viewing.</li>
                <li><h2>Best Months</h2> The best months to see Orion from Antarctica are from late March to early September when the continent experiences the austral winter. During this time, the constellation will be visible for the longest duration each night.</li>
            </ul>
        </div>
        <div class="image">
