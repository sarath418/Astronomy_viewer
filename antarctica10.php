...
<body>
    ...
    <div class="content"> <!-- Added a content div to add padding -->
        <div class="text">
            <h1>SAGITTARIUS</h1>
            <p>The best time, day, and month to see the Sagittarius constellation from Antarctica, or any other location, depends on several factors, including the time of year and your specific location within Antarctica. Here are some general guidelines:</p>
            <ul>
                <li><h2>Time of Year</h2>Sagittarius is best visible during the winter months in the Southern Hemisphere, which corresponds to the summer months in the Northern Hemisphere. In Antarctica, this means that the best time to see Sagittarius is typically from late spring to early autumn. This is when Sagittarius is well-placed in the evening sky.</li>
                <li><h2>Time of Day</h2>Sagittarius is an evening constellation, which means it is best seen after sunset. It rises in the southeast and moves across the night sky, setting in the southwest during the early hours of the morning. The best viewing time is a few hours after sunset when it is higher in the sky.

</li>
                <li><h2>Best Months</h2>The best months to see Sagittarius from Antarctica would typically be from November to February. During this period, Sagittarius is prominent in the evening sky and can be observed for an extended duration.</li>
            </ul>
        </div>
        <div class="image">
