...
<body>
    ...
    <div class="content"> <!-- Added a content div to add padding -->
        <div class="text">
            <h1>ANDROMEDA</h1>
            <p>
The best time, day, and month to see the Andromeda galaxy (M31) from Antarctica, or any other location in the Southern Hemisphere, depends on several factors, including the time of year and your specific location within Antarctica. Here are some general guidelines:</p>
            <ul>
                <li><h2>Time of Year</h2> The Andromeda galaxy is most visible during the autumn and winter months in the Southern Hemisphere, which corresponds to the Northern Hemisphere's spring and summer. This means that the best time to see Andromeda from Antarctica is typically from March to September.</li>
                <li><h2>Time of Day</h2> Andromeda is best observed during the late evening and early night. It is a prominent feature in the northern sky and becomes visible after sunset. For observers in the Southern Hemisphere, it can be seen rising in the northeast.</li>
                <li><h2>Best Months</h2>The best months to see Andromeda from Antarctica would typically be from April to August. During this period, Andromeda is well-placed in the evening sky, and the longer nights provide a better opportunity for stargazing.</li>
            </ul>
        </div>
        <div class="image">
