...
<body>
    ...
    <div class="content"> <!-- Added a content div to add padding -->
        <div class="text">
            <h1>Pegasus</h1>
            <p>Pegasus is a constellation that can be seen from both the Northern and Southern Hemispheres. The best time, day, and month to see Pegasus from Antarctica, which is located in the Southern Hemisphere, is as follows:</p>
            <ul>
                <li><h2>Time of Year</h2>Pegasus is most visible during the summer months in the Southern Hemisphere. In Antarctica, this corresponds to the period from December to February. During these months, Pegasus will be well-placed in the night sky.</li>
                <li><h2>Time of Day</h2>Pegasus is an evening constellation, which means it is best seen after sunset. It rises in the eastern part of the sky and moves westward as the night progresses. The best viewing time is typically a few hours after sunset when Pegasus is higher in the sky.</li>
                <li><h2>Best Months</h2>The best months to see Pegasus from Antarctica would be from December to February. During this time, Pegasus will be prominent in the evening sky and can be observed for an extended duration.</li>
            </ul>
        </div>
        <div class="image">
