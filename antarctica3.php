...
<body>
    ...
    <div class="content"> <!-- Added a content div to add padding -->
        <div class="text">
            <h1>URSA MINOR</h1>
            <p>In Antarctica, the visibility of the Ursa Minor constellation, also known as the Little Dipper, is influenced by its geographical location at the South Pole and the unique characteristics of the southern hemisphere's night sky. Here are some general guidelines for the best time, day, and month to see Ursa Minor from Antarctica:</p>
            <ul>
                <li><h2>Time of Year</h2>Ursa Minor is a circumpolar constellation in the Northern Hemisphere, meaning it can be seen year-round, and it never sets below the horizon. However, in Antarctica, its visibility is greatly affected by the extreme conditions, long polar night, and extreme cold temperatures.</li>
                <li><h2>Time of Day</h2>The best time to see Ursa Minor from Antarctica is during the austral winter, which corresponds to the boreal summer in the Northern Hemisphere. During this time, the constellation is high in the night sky and more easily visible.</li>
                <li><h2>Best Months</h2>The austral winter in Antarctica generally occurs from May to August, with the peak of polar night in June and July. During these months, Ursa Minor is ideally positioned for observation in the night sky, given the continuous darkness during the polar night.</li>
            </ul>
        </div>
        <div class="image">
