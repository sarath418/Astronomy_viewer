...
<body>
    ...
    <div class="content"> <!-- Added a content div to add padding -->
        <div class="text">
            <h1>CASSIOPEIA</h1>
            <p>
The visibility of the Cassiopeia constellation from Antarctica, or any other location on Earth, depends on various factors, including the time of year, the time of day, and your specific location within Antarctica. Here are some general guidelines:</p>
            <ul>
                <li><h2>Time of Year</h2>Cassiopeia is a circumpolar constellation in the Northern Hemisphere, which means it can be seen year-round, but its visibility varies. In Antarctica, the best time to see Cassiopeia would be during the austral summer, from late October to early March. During this period, it should be visible during the night.</li>
                <li><h2>Time of Day</h2>Cassiopeia is visible in the northern part of the sky, and it's a prominent constellation during the evening hours. It is best seen after sunset and throughout the night. The best viewing time is when Cassiopeia is high above the northern horizon.

</li>
                <li><h2>Best Months</h2>The best months to see Cassiopeia from Antarctica would typically be from November to February during the austral summer. During these months, you can expect longer nights and more extended periods of darkness, which are ideal for stargazing.</li>
            </ul>
        </div>
        <div class="image">
