...
<body>
    ...
    <div class="content"> <!-- Added a content div to add padding -->
        <div class="text">
            <h1>Crux</h1>
            <p>The best time, day, and month to see the Crux (Southern Cross) constellation from Antarctica, or any other location in the Southern Hemisphere, depends on the specific location within Antarctica and the time of year. Here are some general guidelines:</p>
            <ul>
                <li><h2>Time of Year</h2>The Crux constellation is most visible during the southern hemisphere's winter months. For Antarctica, this means the best time to see Crux is typically from late autumn (April) to early spring (October). During this period, Crux is well-placed in the night sky and can be observed for an extended duration.</li>
                <li><h2>Time of Day</h2> Crux is a prominent constellation in the southern sky, and it is best seen during the evening hours. It rises in the east and moves across the night sky, setting in the west during the early hours of the morning. The best viewing time is a few hours after sunset when it is higher in the sky.</li>
                <li><h2>Best Months</h2> The best months to observe Crux from Antarctica are typically from May to September. This period aligns with the Antarctic winter, providing longer nights and clearer views of the southern sky. The constellation will be visible for most of the night during these months.</li>
            </ul>
        </div>
        <div class="image">
