...
<body>
    ...
    <div class="content"> <!-- Added a content div to add padding -->
        <div class="text">
            <h1>LEO</h1>
            <p>
The best time, day, and month to see the Leo constellation from Antarctica, or any other location, depend on several factors, including the time of year and your specific location within Antarctica. Here are some general guidelines:

</p>
            <ul>
                <li><h2>Time of Year</h2>Leo is generally visible in the night sky from late winter through early spring in the Southern Hemisphere. In Antarctica, where the seasons are opposite to those in the Northern Hemisphere, the best time to see Leo is during the austral (southern) autumn and early austral winter.</li>
                <li><h2>Time of Day</h2>Leo is an evening constellation, so it is best seen after sunset. It rises in the east and moves across the night sky, setting in the west during the early hours of the morning.</li>
                <li><h2>Best Months</h2>In Antarctica, the best months to see Leo would typically be from March to June. During this period, Leo is well-placed in the evening sky, and you'll have a better chance of observing it for an extended duration.
</li>
            </ul>
        </div>
        <div class="image">
