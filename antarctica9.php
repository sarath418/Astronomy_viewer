...
<body>
    ...
    <div class="content"> <!-- Added a content div to add padding -->
        <div class="text">
            <h1>TAURUS</h1>
            <p>
The visibility of constellations, including Taurus, from Antarctica depends on the time of year and specific locations within Antarctica. Here are some general guidelines:</p>
            <ul>
                <li><h2>Time of Year</h2> Taurus is a winter constellation, which means it is most visible during the winter months in the Southern Hemisphere. In Antarctica, this corresponds to the austral winter, which spans from June to August. Taurus will be well-placed in the night sky during this time.</li>
                <li><h2>Time of Day</h2>Taurus, like many other constellations, is best seen after sunset. It rises in the eastern part of the sky and moves across the night sky, setting in the west during the early hours of the morning. The best viewing time is typically a few hours after sunset when it is higher in the sky.</li>
                <li><h2>Best Months</h2> In Antarctica, the best months to see Taurus would be during the austral winter months of June, July, and August. During this period, Taurus will be prominent in the night sky, and the extended darkness of the polar night can provide excellent viewing conditions.</li>
            </ul>
        </div>
        <div class="image">
