...
<body>
    ...
    <div class="content"> <!-- Added a content div to add padding -->
        <div class="text">
            <h1>SAGITTARIUS</h1>
            <p>Sagittarius is a zodiac constellation and, like all constellations, its visibility from a specific location, including Asia, depends on the time of the year and the specific location within Asia. Here are some general guidelines for the best time, day, and month to see Sagittarius from Asia:</p>
            <ul>
                <li><h2>Time of Year</h2> Sagittarius is most visible during the summer months in the Northern Hemisphere, which corresponds to roughly June to August in Asia. During this time, Sagittarius is well-placed in the evening sky.</li>
                <li><h2>Time of Day</h2> Sagittarius is an evening constellation, and it's best seen after sunset. It typically rises in the southeastern part of the sky and moves across the night sky, setting in the southwest during the early hours of the morning. The best viewing time is a few hours after sunset when it is higher in the sky.</li>
                <li><h2>Best Months</h2> The best months to see Sagittarius from Asia are typically from June to August, when it is prominently visible in the evening sky.</li>
            </ul>
        </div>
        <div class="image">
