...
<body>
    ...
    <div class="content"> <!-- Added a content div to add padding -->
        <div class="text">
            <h1>Pegasus</h1>
            <p>The best time to see the Pegasus constellation from Asia, or any other location, depends on several factors, including the time of year and your specific location within Asia. Here are some general guidelines:</p>
            <ul>
                <li><h2>Time of Year</h2> Pegasus is most visible during the autumn months in the Northern Hemisphere and the spring months in the Southern Hemisphere. In Asia, this means that the best time to see Pegasus is typically from late summer to early autumn.</li>
                <li><h2>Time of Day</h2>Pegasus is an evening constellation, which means it is best seen after sunset. It rises in the east and moves across the night sky, setting in the west during the early hours of the morning. The best viewing time is a few hours after sunset when it is higher in the sky.</li>
                <li><h2>Best Months</h2> The best months to see Pegasus from Asia would typically be from August to November. During this period, Pegasus is prominent in the evening sky and can be observed for an extended duration.</li>
            </ul>
        </div>
        <div class="image">
