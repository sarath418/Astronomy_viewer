...
<body>
    ...
    <div class="content"> <!-- Added a content div to add padding -->
        <div class="text">
            <h1>Crux</h1>
            <p>The visibility of the Crux constellation (also known as the Southern Cross) from Asia can be challenging because it is primarily a southern hemisphere constellation and is not visible from most parts of Asia. Crux is one of the prominent constellations in the southern sky and is often used for navigation in the southern hemisphere. To have the best chance of seeing Crux from Asia, you would need to be in the southernmost regions of the continent, closer to the equator.<br><br>Here are some general guidelines for the best time to see Crux from Asia, considering its southern location:</p>
            <ul>
                <li><h2>Time of Year</h2>Crux is most visible during the southern hemisphere's winter months (May to September) when it is at its highest point in the sky.</li>
                <li><h2>Time of Day</h2>Crux is best seen during the late evening or early morning hours. It rises in the southeast and moves across the southern sky before setting in the southwest.</li>
                <li><h2>Best Months</h2>The best months to see Crux from Asia would typically be during the southern hemisphere's winter months, from May to September.</li>
            </ul>
        </div>
        <div class="image">
