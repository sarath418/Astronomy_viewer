...
<body>
    ...
    <div class="content"> <!-- Added a content div to add padding -->
        <div class="text">
            <h1>LEO</h1>
            <p>The best time, day, and month to see the constellation Leo from Asia, or any other location, depends on several factors, including the time of year and your specific location within Asia. Here are some general guidelines:

</p>
            <ul>
                <li><h2>Time of Year</h2>Leo is most visible during the spring and early summer months in the Northern Hemisphere. In Asia, this means that the best time to see Leo is typically from late winter to early summer. Leo becomes prominent in the evening sky during this period.</li>
                <li><h2>Time of Day</h2>Leo is an evening constellation, so it is best seen after sunset. It rises in the east and moves across the night sky, setting in the west during the late evening hours. The best viewing time is a few hours after sunset when it is higher in the sky.</li>
                <li><h2>Best Months</h2>The best months to see Leo from Asia would typically be from February to July. During this period, Leo is well-placed in the evening sky and can be observed for an extended duration. However, the exact months may vary slightly depending on your specific location within Asia.</li>
            </ul>
        </div>
        <div class="image">
