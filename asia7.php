...
<body>
    ...
    <div class="content"> <!-- Added a content div to add padding -->
        <div class="text">
            <h1>SCORPIUS</h1>
            <p>The visibility of constellations like Scorpius in Asia, or any other location, depends on various factors, including the time of year and your specific location within Asia. Here are some general guidelines for the best time, day, and month to see Scorpius from Asia:</p>
            <ul>
                <li><h2>Time of Year</h2>Scorpius is most visible during the summer months in the Northern Hemisphere. In Asia, this means that the best time to see Scorpius is typically during the months of April to August. During this period, Scorpius is well-placed in the evening sky.</li>
                <li><h2>Time of Day</h2>Scorpius is an evening constellation, which means it is best seen after sunset. It rises in the southeast and moves across the night sky, setting in the west during the early hours of the morning. The best viewing time is a few hours after sunset when it is higher in the sky.</li>
                <li><h2>Best Months</h2>The best months to see Scorpius from Asia are usually from April to August. During these months, Scorpius is prominent in the evening sky, and you can observe its distinct shape and bright stars.</li>
            </ul>
        </div>
        <div class="image">
