...
<body>
    ...
    <div class="content"> <!-- Added a content div to add padding -->
        <div class="text">
            <h1>CYGNUS</h1>
            <p>Cygnus, also known as the Northern Cross, is a prominent constellation in the northern hemisphere's night sky. The best time, day, and month to see Cygnus from Asia, or any other location, depends on the time of year and your specific location within Asia. Here are some general guidelines:</p>
            <ul>
                <li><h2>Time of Year</h2>Cygnus is most visible during the summer months in the northern hemisphere. For observers in Asia, this means that the best time to see Cygnus is typically from late spring to early autumn. During these months, Cygnus will be well-placed in the evening sky.</li>
                <li><h2>Time of Day</h2>Cygnus is an evening constellation, and it's best seen after sunset. It rises in the eastern part of the sky and moves across the night sky, setting in the west during the early hours of the morning. The best viewing time is a few hours after sunset when it is higher in the sky.</li>
                <li><h2>Best Months</h2>The best months to see Cygnus from Asia are typically from May to September. During this period, Cygnus is prominent in the evening sky and can be observed for an extended duration.</li>
            </ul>
        </div>
        <div class="image">
