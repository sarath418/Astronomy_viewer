...
<body>
    ...
    <div class="content"> <!-- Added a content div to add padding -->
        <div class="text">
            <h1>TAURUS</h1>
            <p>The best time, day, and month to see the Taurus constellation from Asia, or any other location, depend on several factors, including the time of year and your specific location within Asia. Here are some general guidelines:</p>
            <ul>
                <li><h2>Time of Year</h2>The Taurus constellation is most visible during the winter months in the Northern Hemisphere and the summer months in the Southern Hemisphere. In Asia, this means that the best time to see Taurus is typically from late autumn to early spring. This is when Taurus is well-placed in the evening sky.</li>
                ...
                <li><h2>Best Months</h2>The best months to see Taurus from Asia would typically be from November to February. During this period, Taurus is prominent in the evening sky and can be observed for an extended duration.</li>
            </ul>
        </div>
        <div class="image">
