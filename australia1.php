...
<body>
    ...
    <div class="content"> <!-- Added a content div to add padding -->
        <div class="text">
            <h1>ORION</h1>
            <p>In Australia, the best time, day, and month to see the Orion constellation can vary depending on the specific region within the continent. Here are some general guidelines:</p>
            <ul>
                <li><h2>Time of Year</h2>The Orion constellation is most visible during the winter months in the Southern Hemisphere. This corresponds to the period from late autumn to early spring in Australia. So, the best time to see Orion in Australia is typically from May to September.</li>
                <li><h2>Time of Day</h2>Orion is an evening constellation, and it is best seen after sunset. It rises in the eastern part of the sky and moves across the night sky, setting in the west during the early hours of the morning. The best viewing time is typically a few hours after sunset when Orion is higher in the sky.</li>
                <li><h2>Best Months</h2>The best months to observe Orion in Australia would typically be from May to September. During this time, Orion is prominent in the evening sky, and you can enjoy extended viewing hours.
.</li>
            </ul>
        </div>
        <div class="image">
