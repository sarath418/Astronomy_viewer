...
<body>
    ...
    <div class="content"> <!-- Added a content div to add padding -->
        ...
        <a class="continent-button" href="asia.php">Asia</a>
    <a class="continent-button" href="africa.php">Africa</a>
    <a class="continent-button" href="north_america.php">North America</a>
    <a class="continent-button" href="south_america.php">South America</a>
    <a class="continent-button" href="europe.php">Europe</a>
    <a class="continent-button" href="australia.php">Australia</a>
    <a class="continent-button" href="antarctica.php">Antarctica</a>
    </div>
</body>
</html>
