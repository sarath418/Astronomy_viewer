...
<body>
    ...
    <div class="content"> <!-- Added a content div to add padding -->
        ...
        <a class="continent-button" href="asia1.php">Asia</a>
    <a class="continent-button" href="africa1.php">Africa</a>
    <a class="continent-button" href="north_america1.php">North America</a>
    <a class="continent-button" href="south_america1.php">South America</a>
    <a class="continent-button" href="europe1.php">Europe</a>
    <a class="continent-button" href="australia1.php">Australia</a>
    <a class="continent-button" href="antarctica1.php">Antarctica</a>
    </div>
</body>
</html>
