...
<body>
    ...
    <div class="content"> <!-- Added a content div to add padding -->
        ...
        <a class="continent-button" href="asia10.php">Asia</a>
    <a class="continent-button" href="africa10.php">Africa</a>
    <a class="continent-button" href="north_america10.php">North America</a>
    <a class="continent-button" href="south_america10.php">South America</a>
    <a class="continent-button" href="europe10.php">Europe</a>
    <a class="continent-button" href="australia10.php">Australia</a>
    <a class="continent-button" href="antarctica10.php">Antarctica</a>
    </div>
</body>
</html>
