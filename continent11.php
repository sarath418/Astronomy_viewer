...
<html>
<head>
    <title>Continent Selection</title>
    <style>
        .continent-button {
...
<body>
    ...
    <div class="content"> <!-- Added a content div to add padding -->
        ...
        <a class="continent-button" href="asia11.php">Asia</a>
    <a class="continent-button" href="africa11.php">Africa</a>
    <a class="continent-button" href="north_america11.php">North America</a>
    <a class="continent-button" href="south_america11.php">South America</a>
    <a class="continent-button" href="europe11.php">Europe</a>
    <a class="continent-button" href="australia11.php">Australia</a>
    <a class="continent-button" href="antarctica11.php">Antarctica</a>
    </div>
</body>
</html>
