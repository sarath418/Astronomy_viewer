...
<body>
    ...
    <div class="content"> <!-- Added a content div to add padding -->
        ...
        <a class="continent-button" href="asia12.php">Asia</a>
    <a class="continent-button" href="africa12.php">Africa</a>
    <a class="continent-button" href="north_america12.php">North America</a>
    <a class="continent-button" href="south_america12.php">South America</a>
    <a class="continent-button" href="europe12.php">Europe</a>
    <a class="continent-button" href="australia12.php">Australia</a>
    <a class="continent-button" href="antarctica12.php">Antarctica</a>
    </div>
</body>
</html>
