...
<body>
    ...
    <div class="content"> <!-- Added a content div to add padding -->
        ...
        <a class="continent-button" href="asia2.php">Asia</a>
    <a class="continent-button" href="africa2.php">Africa</a>
    <a class="continent-button" href="north_america2.php">North America</a>
    <a class="continent-button" href="south_america2.php">South America</a>
    <a class="continent-button" href="europe2.php">Europe</a>
    <a class="continent-button" href="australia2.php">Australia</a>
    <a class="continent-button" href="antarctica2.php">Antarctica</a>
    </div>
</body>
</html>
