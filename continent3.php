...
<body>
    ...
    <div class="content"> <!-- Added a content div to add padding -->
        ...
        <a class="continent-button" href="asia3.php">Asia</a>
    <a class="continent-button" href="africa3.php">Africa</a>
    <a class="continent-button" href="north_america3.php">North America</a>
    <a class="continent-button" href="south_america3.php">South America</a>
    <a class="continent-button" href="europe3.php">Europe</a>
    <a class="continent-button" href="australia3.php">Australia</a>
    <a class="continent-button" href="antarctica3.php">Antarctica</a>
    </div>
</body>
</html>
