...
<body>
    ...
    <div class="content"> <!-- Added a content div to add padding -->
        ...
        <a class="continent-button" href="asia4.php">Asia</a>
    <a class="continent-button" href="africa4.php">Africa</a>
    <a class="continent-button" href="north_america4.php">North America</a>
    <a class="continent-button" href="south_america4.php">South America</a>
    <a class="continent-button" href="europe4.php">Europe</a>
    <a class="continent-button" href="australia4.php">Australia</a>
    <a class="continent-button" href="antarctica4.php">Antarctica</a>
    </div>
</body>
</html>
