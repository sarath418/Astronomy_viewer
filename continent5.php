...
<body>
    ...
    <div class="content"> <!-- Added a content div to add padding -->
        ...
        <a class="continent-button" href="asia5.php">Asia</a>
    <a class="continent-button" href="africa5.php">Africa</a>
    <a class="continent-button" href="north_america5.php">North America</a>
    <a class="continent-button" href="south_america5.php">South America</a>
    <a class="continent-button" href="europe5.php">Europe</a>
    <a class="continent-button" href="australia5.php">Australia</a>
    <a class="continent-button" href="antarctica5.php">Antarctica</a>
    </div>
</body>
</html>
