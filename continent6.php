...
<body>
    ...
    <div class="content"> <!-- Added a content div to add padding -->
        ...
        <a class="continent-button" href="asia6.php">Asia</a>
    <a class="continent-button" href="africa6.php">Africa</a>
    <a class="continent-button" href="north_america6.php">North America</a>
    <a class="continent-button" href="south_america6.php">South America</a>
    <a class="continent-button" href="europe6.php">Europe</a>
    <a class="continent-button" href="australia6.php">Australia</a>
    <a class="continent-button" href="antarctica6.php">Antarctica</a>
    </div>
</body>
</html>
