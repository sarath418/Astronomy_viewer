...
<body>
    ...
    <div class="content"> <!-- Added a content div to add padding -->
        ...
        <a class="continent-button" href="asia7.php">Asia</a>
    <a class="continent-button" href="africa7.php">Africa</a>
    <a class="continent-button" href="north_america7.php">North America</a>
    <a class="continent-button" href="south_america7.php">South America</a>
    <a class="continent-button" href="europe7.php">Europe</a>
    <a class="continent-button" href="australia7.php">Australia</a>
    <a class="continent-button" href="antarctica7.php">Antarctica</a>
    </div>
</body>
</html>
