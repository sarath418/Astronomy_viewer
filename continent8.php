...
<body>
    ...
    <div class="content"> <!-- Added a content div to add padding -->
        ...
        <a class="continent-button" href="asia8.php">Asia</a>
    <a class="continent-button" href="africa8.php">Africa</a>
    <a class="continent-button" href="north_america8.php">North America</a>
    <a class="continent-button" href="south_america8.php">South America</a>
    <a class="continent-button" href="europe8.php">Europe</a>
    <a class="continent-button" href="australia8.php">Australia</a>
    <a class="continent-button" href="antarctica8.php">Antarctica</a>
    </div>
</body>
</html>
