...
<body>
    ...
    <div class="content"> <!-- Added a content div to add padding -->
        ...
        <a class="continent-button" href="asia9.php">Asia</a>
    <a class="continent-button" href="africa9.php">Africa</a>
    <a class="continent-button" href="north_america9.php">North America</a>
    <a class="continent-button" href="south_america9.php">South America</a>
    <a class="continent-button" href="europe9.php">Europe</a>
    <a class="continent-button" href="australia9.php">Australia</a>
    <a class="continent-button" href="antarctica9.php">Antarctica</a>
    </div>
</body>
</html>
