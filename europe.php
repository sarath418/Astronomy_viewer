...
<body>
    ...
    <div class="content"> <!-- Added a content div to add padding -->
        <div class="text">
            <h1>ORION</h1>
            <p>The best time to see the Orion constellation from Europe, or any other location in the Northern Hemisphere, is during the winter months. Here are some details about the best time, day, and months to observe Orion from Europe:</p>
            <ul>
                <li><h2>Time of Year</h2>The Orion constellation is most visible during the winter months in the Northern Hemisphere. In Europe, this typically means that the best time to see Orion is from late autumn (November) through early spring (March). This is when Orion is well-placed in the evening sky.</li>
                ...
                <li><h2>Best Months</h2>The best months to see Orion from Europe would typically be from November to February. During this period, Orion is prominent in the evening sky and can be observed for an extended duration.</li>
            </ul>
        </div>
        <div class="image">
