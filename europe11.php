...
<body>
    ...
    <div class="content"> <!-- Added a content div to add padding -->
        <div class="text">
            <h1>ANDROMEDA</h1>
            <p>
The best time, day, and month to see the Andromeda galaxy (M31) from Europe or any other location depends on several factors, including the time of year and your specific location within Europe. Here are some general guidelines for observing the Andromeda galaxy from Europe:</p>
            <ul>
                <li><h2>Time of Year</h2>The Andromeda galaxy is most easily visible in the Northern Hemisphere during the late summer, autumn, and early winter months.<br><br>In Europe, this means that the best time to see Andromeda is typically from late August to early January.</li>
                <li><h2>Time of Day</h2>Andromeda is visible during the evening and early night hours<br><br>The best viewing time is a few hours after sunset when the sky is sufficiently dark.</li>
                <li><h2>Best Months</h2>The best months to observe Andromeda from Europe would typically be from September to December.<br><br>During this period, Andromeda is well-placed in the night sky, and the sky is darker earlier.</li>
                <li><h2>Moon Phase</h2>It's ideal to observe Andromeda when the Moon is not in the sky or during a New Moon phase. Moonlight can wash out faint objects like galaxies, so choose nights with minimal moonlight for the best viewing.</li>
            </ul>
        </div>
        <div class="image">
