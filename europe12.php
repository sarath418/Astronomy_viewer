...
<body>
    ...
    <div class="content"> <!-- Added a content div to add padding -->
        <div class="text">
            <h1>Pegasus</h1>
            <p>
Pegasus is a prominent constellation in the night sky, and the best time, day, and month to see it from Europe, or any other location in the Northern Hemisphere, can vary throughout the year. Here are some general guidelines:</p>
            <ul>
                <li><h2>Time of Year</h2> Pegasus is most visible during the autumn months in the Northern Hemisphere. In Europe, this means that the best time to see Pegasus is typically from late summer to early winter.</li>
                <li><h2>Time of Day</h2>Pegasus is an evening constellation, which means it is best seen after sunset. It rises in the eastern part of the sky and moves across the night sky during the night. The best viewing time is a few hours after sunset when it is higher in the sky.</li>
                <li><h2>Best Months</h2>The best months to see Pegasus from Europe would typically be from September to December. During this period, Pegasus is well-placed in the evening sky, making it easier to observe.</li>
            </ul>
        </div>
        <div class="image">
