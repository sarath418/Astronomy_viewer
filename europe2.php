...
<body>
    ...
    <div class="content"> <!-- Added a content div to add padding -->
        <div class="text">
            <h1>URSA MAJOR</h1>
            <p>
The visibility of Ursa Major from Europe, like any other constellation, depends on several factors, including the time of year, your specific location within Europe, and the time of day. Here are some general guidelines:</p>
            <ul>
                <li><h2>Time of Year</h2>Ursa Major is a circumpolar constellation in most of Europe, meaning it can be seen year-round. However, it is most prominent during different seasons depending on the hemisphere you're in:<br><br>In the Northern Hemisphere, where Europe is located, Ursa Major is most visible during the spring and summer months. This is when it is high in the northern sky for an extended period during the night.
</li>
                <li><h2>Time of Day</h2>Ursa Major is a northern constellation, so it is visible in the northern part of the sky. To observe it best, you would typically look in the north-northeastern part of the sky during the night.</li>
                <li><h2>Best Months</h2> In Europe, Ursa Major can be observed throughout the year, but the best months to see it clearly and for an extended period would be during the spring and summer months, particularly from March to August.</li>
            </ul>
        </div>
        <div class="image">
