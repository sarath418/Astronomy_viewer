...
<body>
    ...
    <div class="content"> <!-- Added a content div to add padding -->
        <div class="text">
            <h1>URSA MINOR</h1>
            <p>Ursa Minor, also known as the Little Dipper, is a prominent northern hemisphere constellation that contains the North Star (Polaris), making it a useful reference for navigation and stargazing. The best time, day, and month to see Ursa Minor from Europe, like many other constellations, depends on various factors including your specific location within Europe and the time of the year. Here are some general guidelines:</p>
            <ul>
                <li><h2>Time of Year</h2>Ursa Minor is a circumpolar constellation in Europe, which means it can be seen year-round. However, its visibility changes throughout the seasons. You can observe it during all seasons, but it's most visible during the spring and summer months.</li>
                <li><h2>Time of Day</h2> Ursa Minor is a circumpolar constellation, which means it can be seen in the night sky at all hours. It's always above the horizon and doesn't rise or set like other constellations. However, it's most prominent and easiest to spot during the late spring and summer evenings.</li>
                <li><h2>Best Months</h2> The best months to see Ursa Minor from Europe are typically from April to September. During these months, the constellation is high in the northern sky during the evening, making it more accessible and providing an extended viewing period. It's important to note that the exact visibility may vary depending on your specific location within Europe and local light pollution conditions.</li>
            </ul>
        </div>
        <div class="image">
