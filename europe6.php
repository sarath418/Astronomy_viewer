...
<body>
    ...
    <div class="content"> <!-- Added a content div to add padding -->
        <div class="text">
            <h1>LEO</h1>
            <p>The best time, day, and month to see the Leo constellation from Europe, as with most constellations, depends on the time of year and your specific location within Europe. Here are some general guidelines:</p>
            <ul>
                <li><h2>Time of Year</h2> Leo is most visible during the spring months in the Northern Hemisphere, which includes Europe. Spring, specifically the months of March, April, and May, is when Leo is well-placed for observation.</li>
                <li><h2>Time of Day</h2> Leo is an evening constellation, which means it is best seen after sunset. It rises in the eastern part of the sky and moves across the night sky as the night progresses. The best viewing time is typically a few hours after sunset when it is higher in the sky.</li>
                <li><h2>Best Months</h2>As mentioned earlier, the best months to see Leo from Europe are from March to May. During this period, Leo is prominent in the evening sky and can be observed for an extended duration.</li>
            </ul>
        </div>
        <div class="image">
