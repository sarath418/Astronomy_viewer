...
<body>
    ...
    <div class="content"> <!-- Added a content div to add padding -->
        <div class="text">
            <h1>SCORPIUS</h1>
            <p>
Scorpius, a prominent constellation in the southern hemisphere, can be challenging to see from Europe due to its location near the southern celestial hemisphere. However, it is still possible to observe Scorpius under certain conditions.</p>
            <ul>
                <li><h2>Time of Year</h2>Scorpius is best visible from Europe during the summer months. It starts to rise in the southeastern sky in late spring and is more prominent in the evening sky during the summer.</li>
                <li><h2>Time of Day</h2>Scorpius is an evening constellation, which means it is best observed after sunset. It typically rises in the southeast and moves across the southern part of the sky before setting in the southwest during the early hours of the morning.</li>
                <li><h2>Best Months</h2> The best months to see Scorpius from Europe are typically from May to August. During this period, Scorpius is relatively high in the southern sky and is visible for longer durations during the evening.</li>
            </ul>
        </div>
        <div class="image">
