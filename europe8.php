...
<body>
    ...
    <div class="content"> <!-- Added a content div to add padding -->
        <div class="text">
            <h1>CYGNUS</h1>
            <p>
The best time, day, and month to see the Cygnus constellation from Europe, as well as from other northern latitudes, depends on the season and the specific location within Europe. Here are some general guidelines:</p>
            <ul>
                <li><h2>Time of Year</h2>Cygnus is most prominent and well-placed for observation during the summer and autumn months in the Northern Hemisphere. This means the best time to see Cygnus in Europe is typically from late spring to early winter.</li>
                <li><h2>Time of Day</h2>Cygnus is a prominent constellation that can be seen during the evening hours. It rises in the northeastern part of the sky after sunset, and it transits (reaches its highest point in the sky) during the late evening. The best viewing time is a few hours after sunset when it is well above the horizon.</li>
                <li><h2>Best Months</h2>The best months to see Cygnus from Europe would typically be from May to November. During this period, Cygnus is high in the night sky and can be observed for an extended duration.</li>
            </ul>
        </div>
        <div class="image">
