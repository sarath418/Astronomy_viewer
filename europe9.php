...
<body>
    ...
    <div class="content"> <!-- Added a content div to add padding -->
        <div class="text">
            <h1>TAURUS</h1>
            <p>
The best time, day, and month to see the Taurus constellation from Europe, or any other location, depends on several factors, including the time of year and your specific location within Europe. Here are some general guidelines:</p>
            <ul>
                <li><h2>Time of Year</h2> Taurus is most visible during the winter and early spring months in the Northern Hemisphere, which includes Europe. The best time to see Taurus is typically from late autumn through early spring. During this period, Taurus is well-placed in the evening sky.</li>
                <li><h2>Time of Day</h2>Taurus is an evening constellation, which means it is best seen after sunset. It rises in the eastern part of the sky and moves across the night sky, setting in the western part during the early hours of the morning. The best viewing time is a few hours after sunset when it is higher in the sky.</li>
                <li><h2>Best Months</h2> In Europe, the best months to see Taurus would typically be from November to April. During this period, Taurus is prominent in the evening sky and can be observed for an extended duration.</li>
            </ul>
        </div>
        <div class="image">
