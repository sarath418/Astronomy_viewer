...
<body>
    ...
    <div class="content"> <!-- Added a content div to add padding -->
        <div class="text">
            <h1>SAGITTARIUS</h1>
            <p>
The best time, day, and month to see the Sagittarius constellation from North America, like with most constellations, depends on various factors, including the time of year and your specific location within North America. Here are some general guidelines:</p>
            <ul>
                <li><h2>Time of Year</h2>Sagittarius is most visible during the summer months in the Northern Hemisphere, typically from late spring to early autumn. In North America, this means that the best time to see Sagittarius is from May to September. During these months, Sagittarius is well-placed in the evening sky.</li>
                <li><h2>Time of Day</h2> Sagittarius is an evening constellation, which means it is best seen after sunset. It usually rises in the southeast and moves across the southern part of the night sky, setting in the southwest during the early hours of the morning. The best viewing time is a few hours after sunset when it is higher in the sky.</li>
                <li><h2>Best Months</h2>The best months to see Sagittarius from North America would be during the summer, particularly from June to August. During this period, Sagittarius will be prominent in the southern sky, and you'll have a better chance of observing its prominent features and the center of the Milky Way galaxy, which lies within Sagittarius.</li>
            </ul>
        </div>
        <div class="image">
            <img src="SAG.png" alt="Image Description">
        </div>
    </div>
</body>
</html>
