...
<body>
    ...
    <div class="content"> <!-- Added a content div to add padding -->
        <div class="text">
            <h1>LEO</h1>
            <p>
The best time to see the Leo constellation from North America, as well as the day and month, can vary depending on the time of year and your specific location within North America. However, here are some general guidelines:</p>
            <ul>
                <li><h2>Time of Year</h2>The Leo constellation is most visible during the spring and early summer months in North America. Specifically, it is well-placed in the evening sky during late winter and early spring, making it easier to observe.

</li>
                <li><h2>Time of Day</h2>Leo is an evening constellation, which means it is best seen after sunset. It rises in the eastern part of the sky and moves westward as the night progresses. The best viewing time is typically a few hours after sunset when it is higher in the sky.</li>
                <li><h2>Best Months</h2>The best months to see Leo from North America are usually from late February to early June. During this period, Leo is prominently visible in the evening sky, and you can observe its distinctive shape, often referred to as the "Sickle" or "Backwards Question Mark," which forms the head and chest of the celestial lion.</li>
            </ul>
        </div>
        <div class="image">
