...
<body>
    ...
    <div class="content"> <!-- Added a content div to add padding -->
        <div class="text">
            <h1>SAGITTARIUS</h1>
            <p>
The best time, day, and month to see the Sagittarius constellation from South America, or any other location, depends on several factors, including the time of year, your specific location within South America, and local light pollution conditions. Here are some general guidelines for observing Sagittarius:</p>
            <ul>
                <li><h2>Time of Year</h2> Sagittarius is most prominent and visible during the summer months in the Southern Hemisphere. In South America, this means the best time to see Sagittarius is typically from late spring to early autumn. During this period, Sagittarius is high in the night sky.</li>
                <li><h2>Time of Day</h2> Sagittarius is best observed during the late evening and early hours of the morning. It rises in the southeast and moves across the night sky, setting in the southwest. The best viewing time is a few hours after sunset when it is higher in the sky.</li>
                <li><h2>Best Months</h2>The best months to see Sagittarius from South America would typically be from November to February. This is when the constellation is at its highest point in the night sky and is most visible.</li>
            </ul>
        </div>
        <div class="image">
