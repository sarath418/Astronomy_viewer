...
<body>
    ...
    <div class="content"> <!-- Added a content div to add padding -->
        <div class="text">
            <h1>Pegasus</h1>
            <p>The visibility of constellations like Pegasus in South America, as well as the best time, day, and month to see them, depends on the specific location within South America and the time of year. Pegasus is generally visible from the Southern Hemisphere but may vary slightly depending on your exact location.<br><br>Here are some general guidelines for viewing the Pegasus constellation from South America:</p>
            <ul>
                <li><h2>Time of Year</h2>Pegasus is a prominent autumn constellation in the Northern Hemisphere, and it becomes visible from South America as it transitions from late winter to early spring in the Southern Hemisphere.<br><br>The best time to see Pegasus from South America is typically from late July to November. During this period, Pegasus will be well-placed in the evening sky.</li>
                <li><h2>Time of Day</h2>Pegasus is an evening constellation, so it is best observed after sunset.<br><br>The constellation rises in the east and moves across the night sky, setting in the west during the early hours of the morning.</li>
                <li><h2>Best Months</h2>The best months to see Pegasus from South America are typically from September to November when it is high in the evening sky and most visible.</li>
            </ul>
        </div>
        <div class="image">
            <img src="PG.png" alt="Image Description">
        </div>
    </div>
</body>
</html>
