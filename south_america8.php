...
<body>
    ...
    <div class="content"> <!-- Added a content div to add padding -->
        <div class="text">
            <h1>CYGNUS</h1>
            <p>
The best time, day, and month to see the Cygnus constellation from South America, or any other location, depends on several factors, including the time of year and your specific location within South America. Here are some general guidelines:</p>
            <ul>
                <li><h2>Time of Year</h2> Cygnus is a prominent northern hemisphere constellation and is best seen during the summer and autumn months. In South America, this corresponds to the months of December to April. During this period, Cygnus is well-placed in the evening sky.</li>
                <li><h2>Time of Day</h2> Cygnus is an evening constellation, which means it is best seen after sunset. It rises in the east and moves across the night sky, setting in the west during the early hours of the morning. The best viewing time is a few hours after sunset when it is higher in the sky.</li>
                <li><h2>Best Months</h2>The best months to see Cygnus from South America would typically be from December to April. This is when the constellation is high in the sky and visible for longer periods during the night.</li>
            </ul>
        </div>
        <div class="image">
