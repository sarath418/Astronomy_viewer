...
<body>
    ...
    <div class="content"> <!-- Added a content div to add padding -->
        <div class="text">
            <h1>TAURUS</h1>
            <p>Taurus is one of the zodiac constellations and can be observed from South America. The best time, day, and month to see Taurus, like many other constellations, depends on the time of year and your specific location within South America. Here are some general guidelines for observing Taurus:</p>
            <ul>
                <li><h2>Time of Year</h2>Taurus is most prominently visible during the winter and early spring months in the Southern Hemisphere, which includes South America. The best time to see Taurus is typically from late autumn to early spring. This is when it is well-placed in the evening sky and can be seen for an extended period.</li>
                <li><h2>Time of Day</h2>Taurus is an evening constellation, which means it is best seen after sunset. It rises in the east and moves across the night sky, setting in the west during the early hours of the morning. The best viewing time is usually a few hours after sunset when it is higher in the sky.</li>
                <li><h2>Best Months</h2>The best months to see Taurus from South America would typically be from May to September. During this period, Taurus is prominent in the evening sky and can be observed for an extended duration.</li>
            </ul>
        </div>
        <div class="image">
            <img src="TS.png" alt="Image Description">
        </div>
    </div>
</body>
</html>
